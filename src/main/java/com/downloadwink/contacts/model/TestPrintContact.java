...
//
//        Contact contact = contacts.findById(2);
...
//        Contact contact = contacts.findById(2);
//        System.out.println(contact);
//        contacts.updateContact(contact , "Nino" , "Goa" , "nino@gmail.com", "1111111", 30, "haha");
//        System.out.println(contact);
...
//        // Delete contact
//        Contact byId = contacts.findById(4);
//        contacts.deleteContact(byId);


//        // Find by first name
//        Contact someContacts = contacts.findByFirstName("Sanja");
